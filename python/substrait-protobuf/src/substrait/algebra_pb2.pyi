...
class DdlRel(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["common", b"common", "extension_object", b"extension_object", "named_object", b"named_object", "table_defaults", b"table_defaults", "table_schema", b"table_schema", "view_definition", b"view_definition", "write_type", b"write_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["common", b"common", "extension_object", b"extension_object", "named_object", b"named_object", "object", b"object", "op", b"op", "table_defaults", b"table_defaults", "table_schema", b"table_schema", "view_definition", b"view_definition", "write_type", b"write_type"]) -> None: ...
...
class WriteRel(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["common", b"common", "extension_table", b"extension_table", "input", b"input", "named_table", b"named_table", "table_schema", b"table_schema", "write_type", b"write_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["common", b"common", "create_mode", b"create_mode", "extension_table", b"extension_table", "input", b"input", "named_table", b"named_table", "op", b"op", "output", b"output", "table_schema", b"table_schema", "write_type", b"write_type"]) -> None: ...
...
class UpdateRel(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["condition", b"condition", "named_table", b"named_table", "table_schema", b"table_schema", "update_type", b"update_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["condition", b"condition", "named_table", b"named_table", "table_schema", b"table_schema", "transformations", b"transformations", "update_type", b"update_type"]) -> None: ...
...
class Expression(google.protobuf.message.Message):
    ...
    class Literal(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing.Literal["binary", b"binary", "boolean", b"boolean", "date", b"date", "decimal", b"decimal", "empty_list", b"empty_list", "empty_map", b"empty_map", "fixed_binary", b"fixed_binary", "fixed_char", b"fixed_char", "fp32", b"fp32", "fp64", b"fp64", "i16", b"i16", "i32", b"i32", "i64", b"i64", "i8", b"i8", "interval_compound", b"interval_compound", "interval_day_to_second", b"interval_day_to_second", "interval_year_to_month", b"interval_year_to_month", "list", b"list", "literal_type", b"literal_type", "map", b"map", "null", b"null", "precision_timestamp", b"precision_timestamp", "precision_timestamp_tz", b"precision_timestamp_tz", "string", b"string", "struct", b"struct", "time", b"time", "timestamp", b"timestamp", "timestamp_tz", b"timestamp_tz", "user_defined", b"user_defined", "uuid", b"uuid", "var_char", b"var_char"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["binary", b"binary", "boolean", b"boolean", "date", b"date", "decimal", b"decimal", "empty_list", b"empty_list", "empty_map", b"empty_map", "fixed_binary", b"fixed_binary", "fixed_char", b"fixed_char", "fp32", b"fp32", "fp64", b"fp64", "i16", b"i16", "i32", b"i32", "i64", b"i64", "i8", b"i8", "interval_compound", b"interval_compound", "interval_day_to_second", b"interval_day_to_second", "interval_year_to_month", b"interval_year_to_month", "list", b"list", "literal_type", b"literal_type", "map", b"map", "null", b"null", "nullable", b"nullable", "precision_timestamp", b"precision_timestamp", "precision_timestamp_tz", b"precision_timestamp_tz", "string", b"string", "struct", b"struct", "time", b"time", "timestamp", b"timestamp", "timestamp_tz", b"timestamp_tz", "type_variation_reference", b"type_variation_reference", "user_defined", b"user_defined", "uuid", b"uuid", "var_char", b"var_char"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["cast", b"cast", "enum", b"enum", "if_then", b"if_then", "literal", b"literal", "multi_or_list", b"multi_or_list", "nested", b"nested", "rex_type", b"rex_type", "scalar_function", b"scalar_function", "selection", b"selection", "singular_or_list", b"singular_or_list", "subquery", b"subquery", "switch_expression", b"switch_expression", "window_function", b"window_function"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["cast", b"cast", "enum", b"enum", "if_then", b"if_then", "literal", b"literal", "multi_or_list", b"multi_or_list", "nested", b"nested", "rex_type", b"rex_type", "scalar_function", b"scalar_function", "selection", b"selection", "singular_or_list", b"singular_or_list", "subquery", b"subquery", "switch_expression", b"switch_expression", "window_function", b"window_function"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["rex_type", b"rex_type"]) -> typing.Literal["literal", "selection", "scalar_function", "window_function", "if_then", "switch_expression", "singular_or_list", "multi_or_list", "cast", "subquery", "nested", "enum"] | None: ...
