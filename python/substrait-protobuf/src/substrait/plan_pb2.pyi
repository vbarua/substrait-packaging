...
class Plan(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["advanced_extensions", b"advanced_extensions", "expected_type_urls", b"expected_type_urls", "extension_uris", b"extension_uris", "extensions", b"extensions", "relations", b"relations", "version", b"version"]) -> None: ...
